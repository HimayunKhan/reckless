...
const LazyHomeProducts = React.lazy(() => import("@/components/products/HomeProducts"));
    ...
    <>
      <div className=" max-w-screen-xl mx-auto">
        ...
        <div className="relative md:-mt-10 lgl:-mt-32 xl:-mt-55 z-20 mb-10">
          ...
          <Suspense fallback={<div>Loading Home Products...</div>}>
            <LazyHomeProducts data={filteredProducts} />
          </Suspense>
        </div>
      </div>
